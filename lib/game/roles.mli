...
type kind =
  ...
  | Demon
  (** An {!Evil} character with the ability to {b kill} at {{!Phase.Night}Night}.
  *)
  | Traveller
...
type t =
  ...
  *)
  ...
  | Empath
  (** Each {{!Phase.Night}Night}, learn how many of your two {{!Neighbours.t}Neighbours} are {!Evil}.
  *)
  | FortuneTeller
  (** Each {{!Phase.Night}Night}, choose 2 players: you learn if either is a {!Demon}. There is a {!Good} player that registers as a {!Demon} to you (i.e., {b red herring}).
  *)
  | Undertaker
  (** Each {{!Phase.Night}Night}, you learn which {{!Roles.t}Role} died by execution the previous {{!Phase.Day}Day}.
  *)
  | Monk
  (** Each {{!Phase.Night}Night}, choose a player (not yourself): they are {b safe} from the {!Demon} tonight.
  *)
  | Ravenkeeper
  (** If you {b die} at {{!Phase.Night}Night}, you are woken to choose a player: you learn their {{!Roles.t}Role}.
  *)
  | Virgin
  (** The first time you are {i nominated}, if the {b nominator} is a {!Townsfolk}, they are {i executed} immediately.
  *)
  | Slayer
  (** Once per game, during the {{!Phase.Day}Day}, publically choose a player: if they are the {!Demon}, they {b die}.
  *)
  ...
  *)
  | Spy
  (** Each {{!Phase.Night}Night}, you see the {b grimoire}. You might register as {!Good} and as a {!Townsfolk} or {!Outsider}, even if {b dead}. {i (The {b grimoire} shows the state-of-the-game.)}
  *)
  | ScarletWoman
  ...
  *)
  ...
  (* demons *)
  | Imp
  (** Each {{!Phase.Night}Night}, choose a player: they {b die}. If you kill yourself this way, a {!Minion} becomes the {!Imp}.
  *)
