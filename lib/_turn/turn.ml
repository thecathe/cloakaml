...
and player_status =
  | Alive
  | Dead
  | Afflicted of player_affliction

and player_affliction =
  | Cured
  | Sleep
  | Possessed
  | Poisoned
...
and info =
  | Nothing
  | Misinformation of info_kind
  | Disinformation of info_kind
  | Information of info_kind
